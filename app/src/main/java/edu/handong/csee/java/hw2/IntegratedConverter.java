...
/**
*   IntegratedConverter is a class that implment the convert according to the arguments 
*/
public class IntegratedConverter {

    private double fromValue;
    /**
    *   main method that implements run method by making Instance
    */
    ...
    /**
    *   method that gets three arguments from user input and according to the input it implements the converting
    *   from the first arguments to third arguments, first one should be the number value, second one should be original measurement, third one should be target measurement
